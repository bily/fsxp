...
// Source File Name:   StartDeleteTableModel.java
...
public class StartDeleteTableModel extends AbstractTableModel
{

    public StartDeleteTableModel()
    {
        data = new ArrayList();
    }
    ...
    public void setDeleteRow(String type, String number, String designator)
    {
        for(int i = data.size() - 1; i >= 0; i--)
            if(((String)getValueAt(i, 1)).equals(type) && ((String)getValueAt(i, 2)).equals(number) && ((String)getValueAt(i, 3)).equals(designator))
