...
// Source File Name:   DistanceTimeItem.java
...
public class DistanceTimeItem extends Item
{

    public DistanceTimeItem()
    {
        this("distanceTime", 9);
    }

    public DistanceTimeItem(String name, int bit)
    {
        this.name = name;
        dataType = "Word";
        offset = 0;
