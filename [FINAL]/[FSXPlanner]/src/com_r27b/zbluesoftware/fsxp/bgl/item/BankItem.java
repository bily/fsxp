...
// Source File Name:   BankItem.java
...
public class BankItem extends Item
{
    ...
    public BankItem(String name, String dataType, int length)
    {
        this.name = name;
    ...
    public void setDecodedData()
    {
        ...
        {
            float bank = Float.intBitsToFloat(tempData);
            decodedData = new Float(bank);
        }
    }
}
