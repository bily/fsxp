...
// Source File Name:   ParkingNumberItem.java
...
public class ParkingNumberItem extends Item
{

    public ParkingNumberItem()
    {
        this("number");
    }

    public ParkingNumberItem(String name)
    {
        this.name = name;
        dataType = "DWord";
        offset = 0;
    ...
    public void setDecodedData()
    {
        ...
        int dataInt = Long.valueOf(binary.substring(8, 20), 2).intValue();
