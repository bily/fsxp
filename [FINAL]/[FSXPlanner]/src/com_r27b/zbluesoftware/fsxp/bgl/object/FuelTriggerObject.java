...
// Source File Name:   FuelTriggerObject.java
...
public class FuelTriggerObject extends BaseObject
{

    public FuelTriggerObject()
    {
        this(0, 0);
    }

    public FuelTriggerObject(int offset, int length)
    {
        name = "FuelTriggerObject";
        this.offset = offset;
        this.length = length;
        ...
        addItem(new OptionItem("pistonType", 30, "DWord", 4), true);
        addItem(new OptionItem("jetType", 32, "DWord", 4), true);
