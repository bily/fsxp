...
public class FSXPlanner extends JFrame implements ChangeListener, MenuActionListener, PropertyChangeListener {
    ...
    public FSXPlanner()
    {
        super( "FSX Planner [R 27b] - DECOMPILED BY BAO HONG & LEE WEI, DSTA 2008 -" );
        Date date1;
        Date today;
        int maxMemory;
        ILSLineThread ilsLineThread;
        ...
        ilsLineThread = new ILSLineThread( ILSLineUpdates.getInstance() );
        ...
        {
            Object thread = new FSXPlanner$2( this );
    ...
    {
        Object thread = new FSXPlanner$3( this );
    ...
    {
        Object thread = new FSXPlanner$4( this, event );
    ...
    {
        Object thread = new FSXPlanner$6( this );
    ...
    private void enableMenuOptions(boolean status)
    {
        ...
        MenuFactory.getInstance().getMenuAction( new Integer( 76 ) ).setEnabled( status );
        MenuFactory.getInstance().getMenuAction( new Integer( 63 ) ).setEnabled( status );
        ...
        MenuFactory.getInstance().getMenuAction( new Integer( 74 ) ).setEnabled( connected );
