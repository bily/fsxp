...
// Source File Name:   TWPathRunwayNumItem.java
...
public class TWPathRunwayNumItem extends Item
{

    public TWPathRunwayNumItem()
    {
        this("runwayNumber");
    }

    public TWPathRunwayNumItem(String name)
    {
        this.name = name;
        dataType = "Byte";
        offset = 0;
