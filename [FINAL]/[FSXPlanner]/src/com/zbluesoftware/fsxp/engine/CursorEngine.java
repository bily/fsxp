...
public class CursorEngine
{
    ...
    private CursorEngine()
    {
        ...
        taxiwayType = "TAXI";
        parkingType = "RAMP_GA_MEDIUM";
        fenceSize = "{a3a491b1-ef49-47db-9c2b-080f48a5ea5d}";
        blastFenceSize = "{5b05e5fc-915b-4c87-a31d-615bc9dbf1ab}";
    }
    ...
    public String getTaxiwayType()
    {
        return taxiwayType;
    }

    public void setTaxiwayType(String taxiwayType)
    {
        this.taxiwayType = taxiwayType;
    }
    ...
    public void setFenceSize(String fenceSize)
    {
        this.fenceSize = fenceSize;
    }

    public String getBlastFenceSize()
    {
        return blastFenceSize;
    }

    public void setBlastFenceSize(String blastFenceSize)
    {
        this.blastFenceSize = blastFenceSize;
    }
    ...
    private String taxiwayType;
    private String parkingType;
    private String fenceSize;
    private String blastFenceSize;
