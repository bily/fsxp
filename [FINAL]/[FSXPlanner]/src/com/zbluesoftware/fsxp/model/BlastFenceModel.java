...
// Source File Name:   BlastFenceModel.java
...
public class BlastFenceModel extends BaseModel
    implements PropertyChangeListener
{

    public BlastFenceModel()
    {
        modelName = "Blast Fence";
        vertexAL = new ArrayList();
        instanceID = "";
        profile = "{bafc77d3-fa52-4cc2-b713-7609560bb026}";
        modifying = false;
    ...
    public void paint(Graphics2D g2, boolean recreate)
    {
        ...
        if(recreate || modelPath == null)
        {
            ...
            for(int i = 0; i < vertexAL.size() - 1; i++)
            {
    ...
    public Object clone()
    {
        BlastFenceModel model = new BlastFenceModel();
