...
public class NavToolBarPanel extends JPanel
{
    ...
    public NavToolBarPanel()
    {
        ...
        JToggleButton ilsButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(178)));
        ...
        JToggleButton markerButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(179)));
        ...
        JToggleButton vorButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(180)));
        ...
        JToggleButton ndbButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(181)));
        ...
        JToggleButton windsockButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(182)));
        ...
        JToggleButton fuelButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(184)));
        ...
        JToggleButton sceneryButton = new JToggleButton(MenuFactory.getInstance().getMenuAction(new Integer(185)));
