...
public class InstanceEffect
{
  ...
  protected List<TechniqueHint> techniqueHint;
  protected List<Setparam> setparam;
  ...
  public List<TechniqueHint> getTechniqueHint()
  {
    if (this.techniqueHint == null)
      this.techniqueHint = new ArrayList();
    return this.techniqueHint;
  }
  public List<Setparam> getSetparam()
  {
  ...
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name="", propOrder={"bool", "bool2", "bool3", "bool4", "_int", "int2", "int3", "int4", "_float", "float2", "float3", "float4", "float1X1", "float1X2", "float1X3", "float1X4", "float2X1", "float2X2", "float2X3", "float2X4", "float3X1", "float3X2", "float3X3", "float3X4", "float4X1", "float4X2", "float4X3", "float4X4", "surface", "sampler1D", "sampler2D", "sampler3D", "samplerCUBE", "samplerRECT", "samplerDEPTH", "_enum"})
