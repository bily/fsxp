 ...
 * modified by lc0277 with wrappers for default values and generics
 *------------------------------------------------------------------------------
 * Change Log:
...
public final class INIFile
{
    ...
    /**
     * Create a blank iniFile object with no content
     *
     */
    public INIFile() {
        this.mpropEnv = getEnvVars();
...
------------------------------------------------------------------------------*/
    ...
    /**
     * Sets the filename for reading or writing
     * @param fileName
     */
    public void setFileName(String fileName) {
    	this.mstrFile = fileName;
    }
     ...
     * @return the boolean value
     */
    public boolean getBooleanProperty(String pstrSection, String pstrProp, boolean def)
    {
        boolean     blnRet  = def;
        String      strVal  = null;
        INIProperty objProp = null;
     ...
     * @return the integer property value.
     */
    public int getIntegerProperty(String pstrSection, String pstrProp, int def)
    {
    	int     intRet  = def;
        String      strVal  = null;
        INIProperty objProp = null;
        ...
        if (objSec != null)
        {
            ...
            try
            {
                ...
                {
                    strVal = objProp.getPropValue();
                    if (strVal != null) intRet = Integer.parseInt(strVal);
                }
            }
            catch (NumberFormatException NFExIgnore)
            {
    ...
    /**
     * Returns the specified color property from the specified section. The color should
     * be encoded in hex form
     * @param pstrSection the INI section name.
     * @param pstrProp the property to be retrieved.
     * @return the long property value.
     */
    public Color getColorProperty(String pstrSection, String pstrProp, Color def)
    {
    	Color 		colRet 	= def;
        String      strVal  = null;
        INIProperty objProp = null;
     ...
     * @return the long property value.
     */
    public long getLongProperty(String pstrSection, String pstrProp, long def)
    {
    	long        lngRet  = def;
        String      strVal  = null;
        INIProperty objProp = null;
        ...
        if (objSec != null)
        {
            ...
            try
            {
                ...
                {
                    strVal = objProp.getPropValue();
                    if (strVal != null) lngRet = Long.parseLong(strVal);
                }
            }
            catch (NumberFormatException NFExIgnore)
            {
     ...
     * @return the double property value.
     */
    public double getDoubleProperty(String pstrSection, String pstrProp, double def)
    {
    	double      dblRet  = def;
        String      strVal  = null;
        INIProperty objProp = null;
        ...
        if (objSec != null)
        {
            ...
            try
            {
                ...
                {
                    strVal = objProp.getPropValue();
                    if (strVal != null) dblRet = Double.parseDouble(strVal);
                }
            }
            catch (NumberFormatException NFExIgnore)
            {
    ...
    public Iterator<String> numberedSections(String baseName) {
        return new SectionIterator(baseName + ".(\\d+)");
    }

    class SectionIterator implements Iterator<String> {
        Pattern p;
        String next;
        Iterator<String> keysIterator;
        
        SectionIterator(String patString) {
                if (patString != null && !"".equals(patString)) 
                        p = Pattern.compile(patString);
                
                keysIterator = mhmapSections.keySet().iterator();
        ...
        private void findNextMatch() {
                String nextCandidateSection = null;
                while (keysIterator.hasNext()) {
                        String s = keysIterator.next();
                        if (p == null ||
                                        p.matcher(s).matches()) {
                                nextCandidateSection = s;
                                break;
                        }
                }
                next = nextCandidateSection;
        }
...
------------------------------------------------------------------------------*/
    ...
    public List<String> getAllNumberedSectionNames(String base) {
    	List<String> sectionsList = new LinkedList<String>();
    	
    	Pattern p = Pattern.compile(base + ".(\\d+)");
    	for (String secTitle : mhmapSections.keySet()) {
    		if (p.matcher(secTitle).matches()) sectionsList.add(secTitle);
    	}
    	return sectionsList;
    }
    ...
    /**
     * Clear all the contents of this inifile
     *
     */
    public void clear() {
    	mhmapSections.clear();
